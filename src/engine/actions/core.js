export const ACTION_MANIFEST = {
    ...
    'DISCARD': { passiveType: 'BE_DISCARDED', canInvert: true, canBeCost: true, requiresAmount: false, validZones: ['HAND'], endZone: ['DISCARD'], validDurations: ['INSTANT'], isLeavesPlay: true, breaksUndo: true },
    'DISCARD_CARD': { passiveType: 'BE_DISCARDED', canInvert: true, canBeCost: true, requiresAmount: false, validZones: ['HAND'], endZone: ['DISCARD'], validDurations: ['INSTANT'], isLeavesPlay: true, breaksUndo: true },
    'MILL': { passiveType: 'BE_DISCARDED', canInvert: true, canBeCost: true, requiresAmount: false, validZones: ['DECK'], endZone: ['DISCARD'], validDurations: ['INSTANT'], isLeavesPlay: true, breaksUndo: true },
