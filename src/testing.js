...
export async function launchSandboxMatch(itemData, type = 'card') {
    ...
    if (type === 'ability') {
        card = {
            id: 'test_card', name: 'Test Unit', type: 'unit', tribe: 'Generic', cost: 1, health: 1, maxHealth: 1, strength: 1, defaultLine: 'mid', line: 'mid',
            abilities: [itemData], artUrl: '', description: itemData.name + ' test wrapper.'
        };
    } else {
        card = itemData;
    }
    ...
    const dummyCard = {"id":"custom_1785272139394","name":"Target Dummy","tribe":"Carnie","type":"unit","genus":"Generic","cost":1,"health":1,"maxHealth":1,"strength":1,"description":"","artUrl":"","abilities":[],"defaultLine":"mid"};
